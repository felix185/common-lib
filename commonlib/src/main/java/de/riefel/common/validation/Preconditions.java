...
import de.riefel.common.string.StringUtilities;
...
public final class Preconditions {
    ...
    private static final Logger LOG = Logger.getLogger(Preconditions.class);
     ...
     * @exception BusinessException with {@link BaseErrorCode#INVALID_ARGUMENT}.
     */
